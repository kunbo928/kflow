...
suggested_action: k-issue | k-refactor
status: open
---
...
{一句话建议修法，不展开——展开了就是抢 k-issue / k-refactor 的活}

## 建议动作

{`k-issue` 或 `k-refactor`}，因为 {一句话理由}
```
