...
kflow search --dir .kflow/compound --filter doc_type=decision --filter category=constraint --filter status=active

# 归档后查重叠

kflow search --dir .kflow/compound --filter doc_type=decision --query "{关键词}" --json
```
